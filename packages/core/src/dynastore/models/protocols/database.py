...
class DbConnectionProtocol(DbResourceProtocol, Protocol):
    ...
    def execute(self, statement: Union[str, TextClause], parameters: Optional[dict[str, Any]] = None) -> Result[Any]: ...
    def begin(self) -> Any: ...
...
class DbAsyncConnectionProtocol(DbAsyncResourceProtocol, Protocol):
    ...
    async def execute(self, statement: Union[str, TextClause], parameters: Optional[dict[str, Any]] = None) -> Result[Any]: ...
    def begin(self) -> Any: ...
    def begin_nested(self) -> Any: ...
    def in_transaction(self) -> bool: ...
    @property
