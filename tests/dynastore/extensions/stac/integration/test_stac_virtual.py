...
@pytest.mark.enable_modules(
    "db_config", "db", "catalog", "stac", "processes", "tasks", "proxy", "gcp", "iam", "collection_postgresql", "collection_postgresql", "catalog_postgresql", "catalog_postgresql"
)
...
async def test_virtual_stac_endpoints(sysadmin_in_process_client, in_process_client, test_data_loader, base_url):
    ...
    resp = await in_process_client.put(
        f"/configs/catalogs/{catalog_id}/collections/{collection_id}/classes/StacPluginConfig",
