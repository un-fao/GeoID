...
def test_content_extent_default_crs():
    from dynastore.extensions.volumes.volumes_models import ContentExtent
...
def test_content_link_required_fields():
    from dynastore.extensions.volumes.volumes_models import ContentLink
...
def test_child_ref_wire_shape():
    from dynastore.extensions.volumes.volumes_models import ChildRef
...
def test_parse_bbox_4_numbers():
    from dynastore.extensions.volumes.volumes_models import _parse_bbox
...
def test_bbox_intersects_2d():
    from dynastore.extensions.volumes.volumes_models import _bbox_intersects
